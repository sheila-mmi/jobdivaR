#' JobDiva Create Candidate Note
#' 
#' This function will create a note for a candidate in JobDiva
#' 
#' @param candidate_id (type: string) -- a string with the candidate id to add the note to
...
jobdiva_create_candidate_note = function(candidate_id
                                       , note_body = ""
                                       , note_owner_id = ""
                                       , action = "")
{
  ...
  url = paste0('https://api.jobdiva.com/api/jobdiva/createCandidateNote?candidateid='
               , vars[1]
               , '&note='
               , vars[2]
               , '&recruiterid='
